...
- Per-project Reminders lists (Near-term) now handle the "structured task list" use case. This entry is more specifically about smarter handling of the *startup inbox* — overdue, due-today, multi-list filtering across the captured-on-phone surface.
